  ...
  "lessons": [
    {
      ...
      "exercises": [
        {
          "tipo": "gap",
          "id": "e1a",
          "t": "A · Léxico en contexto",
          "intro": "Completá con una palabra o expresión del banco. Cada una se usa una sola vez.",
          "banco": [
            "apalancamiento",
            "centros de datos",
            "desembolso",
          ...
          "items": [
            {
              "q": "El ___ de las empresas ligadas a la IA se multiplicó por diez en una década.",
              "a": [
                "valor de mercado"
              ]
            },
            {
              "q": "El sector dejó de financiarse con ___ propio y pasó a financiarse con deuda.",
              "a": [
                "flujo de caja"
              ]
            },
            {
              "q": "Cuando un ___ invierte en su propio cliente, el circuito se cierra sobre sí mismo.",
              "a": [
                "proveedor"
              ]
            },
            {
              "q": "Levantar ___ exige energía, refrigeración y conexión a la red eléctrica.",
              "a": [
                "centros de datos"
              ]
            },
            {
              "q": "Un ___ excesivo vuelve frágil a cualquier empresa ante una corrección del mercado.",
              "a": [
                "endeudamiento"
              ]
            },
            {
              "q": "Ningún inversor pone capital sin esperar algún tipo de ___.",
              "a": [
                "rentabilidad"
              ]
            },
            {
              "q": "La ___ de los chips obliga a reemplazarlos cada pocos años.",
              "a": [
                "obsolescencia"
              ]
            },
            {
              "q": "La ___ en el sector fue el principal motor del crecimiento estadounidense en 2025.",
              "a": [
                "inversión fija"
              ]
            },
            {
              "q": "Operar con ___ multiplica tanto las ganancias como las pérdidas.",
              "a": [
                "apalancamiento"
              ]
            },
            {
              "q": "El ___ inicial del proyecto supera los treinta mil millones de dólares.",
              "a": [
                "desembolso"
              ]
            }
        ...
        },
        {
          "tipo": "modelo",
          "id": "e1b",
          "t": "B · Unir en una sola oración",
          "intro": "Fusioná cada par usando <b>preposición + el/la/los/las cual(es)</b> o <b>cuyo/a/os/as</b>. Escribí tu versión y después compará.",
          "items": [
            {
              "q": "Existe un mecanismo. A través de ese mecanismo el capital vuelve al emisor.",
              "m": "Existe un mecanismo a través del cual el capital vuelve al emisor."
            },
            {
              "q": "Se firmaron acuerdos. Gracias a esos acuerdos la valuación se sostuvo dos años más.",
              "m": "Se firmaron acuerdos gracias a los cuales la valuación se sostuvo dos años más."
            },
            {
              "q": "Hay un umbral. A partir de ese umbral la liquidez desaparece.",
              "m": "Hay un umbral a partir del cual la liquidez desaparece."
            },
            {
              "q": "Es un activo. El componente clave de ese activo se deprecia en cinco años.",
              "m": "Es un activo cuyo componente clave se deprecia en cinco años."
            },
            {
              "q": "El autor describe una estrategia. Según esa estrategia, los precios se mantienen bajos al principio.",
              "m": "El autor describe una estrategia según la cual los precios se mantienen bajos al principio."
            },
            {
              "q": "Son empresas. Los balances de esas empresas parecen sólidos.",
              "m": "Son empresas cuyos balances parecen sólidos."
            }
          ]
        },
        {
          "tipo": "opcion",
          "id": "e1c",
          "t": "C · Elegí la forma correcta",
          "intro": "Una sola opción es correcta en cada caso.",
          "items": [
            {
              "q": "Es un mecanismo ___ el capital vuelve al emisor.",
              "o": [
                "que a través de él",
                "a través del cual",
                "a través de que"
            ...
            {
              "q": "Una empresa ___ valuación se disparó en seis meses no siempre vale más.",
              "o": [
                "que su",
                "cuya",
                "de la cual"
            ...
            {
              "q": "___ compraron en el pico perdieron casi todo.",
              "o": [
                "Los que quien",
                "Quienes",
                "Que"
            ...
            {
              "q": "El circuito ___ se financia la propia demanda es cerrado.",
              "o": [
                "por lo cual",
                "por el cual",
                "por que"
            ...
            {
              "q": "Es una tecnología ___ depende toda la industria.",
              "o": [
                "de la cual",
                "de que",
                "la cual"
            ...
            {
              "q": "Hay razones económicas ___ el fenómeno se explica.",
              "o": [
                "que",
                "por las cuales",
                "las cuales"
      ...
      "essay": {
        ...
        "maxWords": 180,
        "checklist": [
          "Tres oraciones relativas: al menos una con preposición + el/la cual y una con cuyo.",
    ...
    },
    {
      ...
      "exercises": [
        {
          ...
          "id": "e2a",
          "t": "A · Léxico en contexto",
          "intro": "Completá con una expresión del banco.",
          "banco": [
            "arrendamiento",
            "balance patrimonial",
            "capital privado",
          ...
          "items": [
            {
              "q": "Las instalaciones pertenecen a una ___ entre dos compañías.",
              "a": [
                "empresa conjunta"
              ]
            },
            {
              "q": "La mayor parte del dinero no la ponen los socios, sino los ___.",
              "a": [
                "tenedores de bonos"
              ]
            },
            {
              "q": "La empresa se compromete a un contrato de ___ a largo plazo.",
              "a": [
                "arrendamiento"
              ]
            },
            {
              "q": "La estructura permite aprovechar la ___ de la matriz sin cargar la deuda en su balance.",
              "a": [
                "solvencia crediticia"
              ]
            },
            {
              "q": "Está dispuesta a pagar cerca del 1% de su ___ para financiar la obra.",
              "a": [
                "balance patrimonial"
              ]
            },
            {
              "q": "Nadie quiere quedarse con el ___ si el proyecto no rinde.",
              "a": [
                "riesgo residual"
              ]
            },
            {
              "q": "Una firma de ___ aporta parte de los fondos.",
              "a": [
                "capital privado"
              ]
            },
            {
              "q": "Detrás de toda esa ___ hay una sola pregunta: quién pierde si esto falla.",
              "a": [
                "ingeniería financiera"
              ]
            },
            {
              "q": "El acuerdo resulta ___ del momento que atraviesa el mercado.",
              "a": [
                "sintomático"
              ]
            },
            {
              "q": "La ___ de largo plazo es lo que vuelve confiable la operación.",
              "a": [
                "garantía"
              ]
            }
        ...
        },
        {
          "tipo": "gap",
          "id": "e2b",
          "t": "B · <i>Aunque</i> + indicativo o subjuntivo",
          "intro": "Escribí el verbo en la forma correcta.",
          "regla": "<b>Indicativo</b> cuando presentás el dato como verificado y querés afirmarlo: <i>Aunque el gasto <b>es</b> enorme…</i> &nbsp;·&nbsp; <b>Subjuntivo</b> cuando es una hipótesis, o cuando el dato ya es sabido y no lo estás afirmando de nuevo: <i>Aunque el gasto <b>sea</b> enorme…</i>",
          "items": [
            {
              "q": "Aunque los balances ___ (parecer) sólidos, ya se ven fisuras. [dato verificado]",
              "a": [
                "parecen"
              ]
            },
            {
              "q": "Aunque ___ (haber) una corrección fuerte, las grandes empresas van a sobrevivir. [hipótesis]",
              "a": [
                "haya"
              ]
            },
            {
              "q": "Aunque el gasto ___ (ser) enorme, nadie garantiza las ganancias. [dato verificado]",
              "a": [
                "es"
              ]
            },
            {
              "q": "Aunque no lo ___ (reconocer) en público, buscan protegerse. [no lo afirmo]",
              "a": [
                "reconozcan"
              ]
            },
            {
              "q": "Aunque la adopción ___ (crecer) más lento de lo previsto, sigue creciendo. [dato verificado]",
              "a": [
                "crece"
              ]
            },
            {
              "q": "Aunque mañana ___ (estallar) la burbuja, la infraestructura queda. [hipótesis futura]",
              "a": [
                "estalle"
              ]
            },
            {
              "q": "Aunque el contrato ya ___ (estar) firmado, todavía puede renegociarse. [dato verificado]",
              "a": [
                "está"
              ]
            },
            {
              "q": "Aunque me ___ (decir, ellos) lo contrario, no lo creería. [hipótesis]",
              "a": [
                "dijeran",
                "dijesen"
              ]
        ...
        },
        {
          "tipo": "modelo",
          "id": "e2c",
          "t": "C · Reformular la concesión",
          "intro": "Reescribí cada oración con el recurso indicado.",
          "items": [
            {
              "q": "El gasto es enorme, pero nadie garantiza las ganancias. → empezá con <b>Si bien</b>",
              "m": "Si bien el gasto es enorme, nadie garantiza las ganancias."
            },
            {
              "q": "La adopción crece despacio, pero crece. → empezá con <b>A pesar de que</b>",
              "m": "A pesar de que la adopción crece despacio, crece."
            },
            {
              "q": "Podés explicárselo mil veces: no lo va a entender. → usá <b>Por más que</b>",
              "m": "Por más que se lo expliques mil veces, no lo va a entender."
            },
            {
              "q": "Los balances son sólidos, pero eso no prueba nada. → usá <b>Aunque</b> + indicativo",
              "m": "Aunque los balances son sólidos, eso no prueba nada."
            },
            {
              "q": "El proyecto puede fracasar y aun así siguen invirtiendo. → usá <b>Aun cuando</b>",
              "m": "Aun cuando el proyecto pueda fracasar, siguen invirtiendo."
            }
          ]
        }
      ],
      "essay": {
        ...
        "maxWords": 180,
        "checklist": [
          "Dos concesivas distintas; una de ellas con por más que + subjuntivo.",
    ...
    },
    {
      ...
      "exercises": [
        {
          ...
          "items": [
            {
              "q": "Los proveedores necesitarían ___ enormes solo para llegar a una ganancia del 10%.",
              "a": [
                "ingresos anuales"
              ]
            },
            {
              "q": "Se trata de una ___ que ningún analista considera realista.",
              "a": [
                "cifra exorbitante"
              ]
            },
            {
              "q": "Los precios se mantienen ___ bajos para atraer usuarios.",
              "a": [
                "artificialmente"
              ]
            },
            {
              "q": "La estrategia consiste en ___ al cliente antes de subir el precio.",
              "a": [
                "fidelizar"
              ]
            },
            {
              "q": "Hay un ___ inicial: primero se paga el costo de aprender a usar la tecnología.",
              "a": [
                "desfase"
              ]
            },
            {
              "q": "Con el tiempo, quienes la ___ temprano obtienen beneficios.",
              "a": [
                "adoptan"
              ]
            },
            {
              "q": "Cuando los ___ son prohibitivos, el cliente ya no puede irse.",
              "a": [
                "costos de salida"
              ]
            },
            {
              "q": "La ___ queda atrapada dentro del servicio.",
              "a": [
                "base de clientes"
              ]
            },
            {
              "q": "Los que aguantaron el desfase terminaron por ___ los beneficios.",
              "a": [
                "cosechar"
              ]
            },
            {
              "q": "Nadie puede sostener esos ingresos ___.",
              "a": [
                "a perpetuidad"
              ]
            }
        ...
        },
        {
          "tipo": "opcion",
          "id": "e3b",
          "t": "B · El verbo de atribución justo",
          "intro": "«Decir» sirve para todo y por eso no sirve para nada. Elegí el verbo que indica <i>qué está haciendo</i> esa voz en el argumento.",
          "regla": "<b>Sostener / argumentar</b>: defiende una posición. &nbsp;<b>Señalar</b>: hace notar un hecho. &nbsp;<b>Advertir</b>: alerta sobre un riesgo. &nbsp;<b>Estimar</b>: calcula. &nbsp;<b>Reconocer</b>: admite algo que no lo favorece. &nbsp;<b>Matizar</b>: baja la fuerza de lo dicho. &nbsp;<b>Descartar</b>: rechaza una posibilidad.",
          "items": [
            {
              "q": "Durand ___ que las cifras no cuadran.",
              "o": [
                "sostiene",
                "habla",
                "comenta"
            ...
            {
              "q": "El Banco de Pagos Internacionales ___ sobre los efectos de una corrección bursátil.",
              "o": [
                "cuenta",
                "advierte",
                "informa un poco"
            ...
            {
              "q": "JP Morgan ___ los ingresos necesarios en 650.000 millones de dólares.",
              "o": [
                "piensa",
                "cree",
                "estima"
            ...
            {
              "q": "El autor ___ que existen aumentos de productividad en algunas tareas concretas.",
              "o": [
                "niega",
                "reconoce",
                "declara"
            ...
            {
              "q": "Acemoğlu y Johnson ___ que la eficiencia depende del contexto institucional.",
              "o": [
                "conversan",
                "argumentan",
                "opinan un poco"
            ...
            {
              "q": "El autor no ___ que las grandes empresas se beneficien de una crisis del sector.",
              "o": [
                "descarta",
                "aumenta",
                "repite"
            ...
            {
              "q": "Roberts ___ el contraste entre el enfoque chino y el estadounidense.",
              "o": [
                "mira",
                "señala",
                "dice mucho"
            ...
            {
              "q": "El analista ___ su afirmación aclarando que la evidencia todavía es limitada.",
              "o": [
                "matiza",
                "amplía",
                "insiste"
        ...
        },
        {
          "tipo": "modelo",
          "id": "e3c",
          "t": "C · Pasar a discurso referido",
          "intro": "Convertí cada cita en discurso indirecto con el verbo indicado. Cuidado con los tiempos y las personas.",
          "items": [
            {
              "q": "«Los números no cuadran.» → <b>sostener</b>, presente",
              "m": "El autor sostiene que los números no cuadran."
            },
            {
              "q": "«La adopción se está frenando.» → <b>advertir</b>, presente",
              "m": "Advierte que la adopción se está frenando."
            },
            {
              "q": "«Pudimos hacerlo porque existían cuarenta años de inversión pública.» → <b>reconocer</b>, pasado",
              "m": "Reconoció que habían podido hacerlo porque existían cuarenta años de inversión pública."
            },
            {
              "q": "«Si la eficiencia se materializa, no habrá ningún problema.» → <b>argumentar</b>",
              "m": "Argumenta que, si la eficiencia se materializa, no habrá ningún problema."
            },
            {
              "q": "«¿Quién refinanciará un activo depreciado?» → <b>preguntarse</b>",
              "m": "Se pregunta quién refinanciará un activo depreciado."
            }
          ]
        }
      ],
      "essay": {
        ...
        "maxWords": 160,
        "checklist": [
          "Dos verbos de atribución distintos; ninguno puede ser «decir».",
    ...
    },
    {
      ...
      "exercises": [
        {
          ...
          "items": [
            {
              "q": "Se están intensificando los ___.",
              "a": [
                "vientos en contra"
              ]
            },
            {
              "q": "La ___ disponible es todavía limitada.",
              "a": [
                "evidencia"
              ]
            },
            {
              "q": "El uso de la IA en el trabajo podría estar ___.",
              "a": [
                "ralentizándose"
              ]
            },
            {
              "q": "Involucra solo a una pequeña parte de la ___.",
              "a": [
                "fuerza laboral"
              ]
            },
            {
              "q": "No hay señales de una ___ inminente.",
              "a": [
                "disrupción"
              ]
            },
            {
              "q": "El peligro más inmediato sería una epidemia de ___ laboral.",
              "a": [
                "desmoralización"
              ]
            },
            {
              "q": "El uso intensivo resulta ___: el trabajador va perdiendo oficio.",
              "a": [
                "descalificante"
              ]
            },
            {
              "q": "Una tecnología poderosa puede no ser ___ si la estructura del mercado no lo permite.",
              "a": [
                "redituable"
              ]
            },
            {
              "q": "La automatización puede empobrecer si conduce a ___ masivos.",
              "a": [
                "despidos"
              ]
            },
            {
              "q": "El contraste entre los dos enfoques resulta ___.",
              "a": [
                "aleccionador"
              ]
            }
        ...
        },
        {
          "tipo": "gap",
          "id": "e4b",
          "t": "B · Indicativo o subjuntivo tras expresiones de opinión",
          "intro": "Escribí el verbo en la forma correcta.",
          "regla": "Cuando <b>afirmás</b>, indicativo: <i>creo que, me parece que, es evidente que, está demostrado que</i>. Cuando <b>negás la afirmación, dudás o valorás</b>, subjuntivo: <i>no creo que, no está claro que, es probable que, dudo que, es lógico que</i>.",
          "items": [
            {
              "q": "Creo que la burbuja ___ (ir) a estallar.",
              "a": [
                "va"
              ]
            },
            {
              "q": "No creo que la burbuja ___ (ir) a estallar.",
              "a": [
                "vaya"
              ]
            },
            {
              "q": "Es evidente que el gasto ___ (ser) desmedido.",
              "a": [
                "es"
              ]
            },
            {
              "q": "No está claro que el gasto ___ (ser) sostenible.",
              "a": [
                "sea"
              ]
            },
            {
              "q": "Me parece que la evidencia ___ (ser) insuficiente.",
              "a": [
                "es"
              ]
            },
            {
              "q": "No me parece que la evidencia ___ (ser) suficiente.",
              "a": [
                "sea"
              ]
            },
            {
              "q": "Es probable que los precios ___ (subir) en dos años.",
              "a": [
                "suban"
              ]
            },
            {
              "q": "Está demostrado que la adopción ___ (crecer) más lento de lo previsto.",
              "a": [
                "crece"
              ]
            },
            {
              "q": "Dudo que las empresas ___ (poder) sostener esos precios.",
              "a": [
                "puedan"
              ]
            },
            {
              "q": "Es lógico que los inversores ___ (buscar) protegerse.",
              "a": [
                "busquen"
              ]
            }
        ...
        },
        {
          ...
          "id": "e4c",
          "t": "C · Bajar la fuerza",
          "intro": "Reescribí cada afirmación tajante en una versión modalizada, con el recurso indicado. Fijate que la idea no se pierde: se vuelve más difícil de refutar.",
          "items": [
            {
              "q": "La IA no aumenta la productividad. → <b>todo indica que</b>",
              "m": "Todo indica que la IA no aumenta la productividad tanto como se esperaba."
            },
            {
              "q": "Va a estallar. → <b>podría</b>",
              "m": "Podría estallar en cualquier momento."
            },
            {
              "q": "Nadie va a pagar esos precios. → <b>habría que ver si</b>",
              "m": "Habría que ver si alguien está dispuesto a pagar esos precios."
            },
            {
              "q": "Es una estafa. → <b>no es que… sino que…</b>",
              "m": "No es que se trate de una estafa, sino que las expectativas superan ampliamente a la evidencia."
            },
            {
              "q": "Los inversores no entienden el riesgo. → <b>buena parte de… parece…</b>",
              "m": "Buena parte de los inversores parece no comprender el riesgo que está asumiendo."
            }
          ]
        }
      ],
      "essay": {
        ...
        "maxWords": 190,
        "checklist": [
          "Un verbo de atribución para presentar el dato del artículo.",
    ...
    },
    {
      ...
      "exercises": [
        {
          ...
          "items": [
            {
              "q": "Las economías capitalistas enfrentan un grave problema de ___.",
              "a": [
                "coordinación"
              ]
            },
            {
              "q": "En China hay un plan para alcanzar ___ tecnológicos claves.",
              "a": [
                "objetivos"
              ]
            },
            {
              "q": "Todos los huevos están puestos en una sola ___.",
              "a": [
                "canasta"
              ]
            },
            {
              "q": "Los ___ privados concentran la mayor parte de la inversión.",
              "a": [
                "hiperescaladores"
              ]
            },
            {
              "q": "Para ellos lo fundamental es la ___, no el resultado tecnológico.",
              "a": [
                "rentabilidad"
              ]
            },
            {
              "q": "El ___ estadounidense y el chino no se parecen en nada.",
              "a": [
                "enfoque"
              ]
            },
            {
              "q": "El ___ de la industria explica buena parte del problema.",
              "a": [
                "liderazgo privado"
              ]
            },
            {
              "q": "Una porción importante de la inversión puede terminar en puro ___.",
              "a": [
                "desperdicio"
              ]
            },
            {
              "q": "Se trata de una ___ casi religiosa.",
              "a": [
                "apuesta"
              ]
            },
            {
              "q": "Sin ___ estatal, cada empresa va por su lado.",
              "a": [
                "planificación"
              ]
            }
        ...
        },
        {
          "tipo": "opcion",
          "id": "e5b",
          "t": "B · El conector de contraste justo",
          "intro": "No todos los conectores de contraste hacen lo mismo. Elegí el que corresponde.",
          "items": [
            {
              "q": "En China hay un plan estatal, ___ en Estados Unidos decide el mercado.",
              "o": [
                "mientras que",
                "sin embargo",
                "además"
            ...
            {
              "q": "___ China, Estados Unidos no coordina centralmente la inversión.",
              "o": [
                "Al igual que",
                "A diferencia de",
                "Junto con"
            ...
            {
              "q": "El sector privado busca rentabilidad. El Estado, ___, busca capacidad instalada.",
              "o": [
                "en cambio",
                "por lo tanto",
                "incluso"
            ...
            {
              "q": "___ los proveedores ___ los clientes se benefician del circuito.",
              "o": [
                "Tanto… como",
                "Ni… ni",
                "Sea… sea"
            ...
            {
              "q": "Los balances parecen sólidos. ___, ya aparecen fisuras en los jugadores más débiles.",
              "o": [
                "Por eso",
                "Sin embargo",
                "Es decir"
            ...
            {
              "q": "___ el diagnóstico es correcto, la solución propuesta no convence.",
              "o": [
                "Si bien",
                "Porque",
                "Así que"
            ...
            {
              "q": "No se trata de frenar la inversión. ___, se trata de orientarla.",
              "o": [
                "Por el contrario",
                "En consecuencia",
                "Del mismo modo"
            ...
            {
              "q": "El argumento se sostiene. ___, conviene revisar de dónde salen los datos.",
              "o": [
                "Ahora bien",
                "Por ejemplo",
                "Es decir"
        ...
        },
        {
          "tipo": "modelo",
          "id": "e5c",
          "t": "C · Comparar en una sola oración",
          "intro": "Con cada par de datos, escribí una sola oración usando el recurso indicado.",
          "items": [
            {
              "q": "EE.UU.: inversión privada dispersa / China: plan estatal. → <b>mientras que</b>",
              "m": "En Estados Unidos la inversión queda en manos privadas y dispersas, mientras que en China responde a un plan estatal."
            },
            {
              "q": "Ferrocarriles del siglo XIX: duran décadas / chips de IA: se deprecian en cinco años. → <b>a diferencia de</b>",
              "m": "A diferencia de los ferrocarriles del siglo XIX, que siguieron en servicio durante décadas, los chips de IA se deprecian casi por completo en cinco años."
            },
            {
              "q": "Ciclo cripto: predominio de pequeños inversores / ciclo IA: predominio de fondos institucionales. → <b>en cambio</b>",
              "m": "En el ciclo cripto predominaron los pequeños inversores; en el de la IA, en cambio, predominan los fondos institucionales."
            },
            {
              "q": "Los dos ciclos comparten el financiamiento cruzado. → <b>tanto… como…</b>",
              "m": "Tanto el ciclo cripto como el actual descansan sobre mecanismos de financiamiento cruzado."
            },
            {
              "q": "El diagnóstico es sólido / la solución es débil. → <b>si bien</b>",
              "m": "Si bien el diagnóstico es sólido, la solución que propone resulta considerablemente más débil."
            }
          ]
        }
      ],
      "essay": {
        ...
        "maxWords": 170,
        "checklist": [
          "Dos concesivas; una de ellas con por más que + subjuntivo.",
    ...
    },
    {
      ...
      "exercises": [
        {
          ...
          "items": [
            {
              "q": "Buena parte del ___ material de burbujas anteriores todavía se usa.",
              "a": [
                "legado"
              ]
            },
            {
              "q": "Los chips se ___ mucho más rápido que una vía férrea.",
              "a": [
                "deprecian"
              ]
            },
            {
              "q": "Los préstamos no se ___: los pagos no reducen la deuda.",
              "a": [
                "amortizan"
              ]
            },
            {
              "q": "Al final del plazo se ___ la totalidad de la deuda.",
              "a": [
                "refinancia"
              ]
            },
            {
              "q": "Se asume que estamos ante un ___ que nunca pierde valor.",
              "a": [
                "activo perpetuo"
              ]
            },
            {
              "q": "Si las inversiones se ___, la capacidad disponible se reduce.",
              "a": [
                "estancan"
              ]
            },
            {
              "q": "Hablamos de un posible ___ de la oferta de cómputo.",
              "a": [
                "achicamiento"
              ]
            },
            {
              "q": "La fibra óptica de la era ___ sigue en servicio treinta años después.",
              "a": [
                "punto com"
              ]
            },
            {
              "q": "La ___ es el problema central de este tipo de activo.",
              "a": [
                "obsolescencia"
              ]
            },
            {
              "q": "Nadie va a refinanciar el ___ de un préstamo cuyo activo ya no vale nada.",
              "a": [
                "saldo"
              ]
            }
        ...
        },
        {
          "tipo": "opcion",
          "id": "e6b",
          "t": "B · Conectores contraargumentativos y consecutivos",
          "intro": "Elegí el conector que corresponde a la relación lógica.",
          "regla": "Ojo con <b>de ahí que</b>: siempre lleva subjuntivo. <i>El activo se deprecia, de ahí que nadie <b>quiera</b> refinanciarlo.</i>",
          "items": [
            {
              "q": "Los chips pierden valor en cinco años; ___, nadie querrá refinanciar ese activo.",
              "o": [
                "por lo tanto",
                "aun así",
                "es decir"
            ...
            {
              "q": "La analogía con los ferrocarriles falla. ___, la infraestructura ferroviaria duró más de un siglo.",
              "o": [
                "De hecho",
                "En cambio",
                "Aun así"
            ...
            {
              "q": "Los balances de los grandes son sólidos; ___, ya aparecen fisuras en los más débiles.",
              "o": [
                "por eso",
                "no obstante",
                "de ahí que"
            ...
            {
              "q": "El activo se deprecia casi por completo, ___ el refinanciamiento resulte improbable.",
              "o": [
                "por lo tanto",
                "de ahí que",
                "aun así"
            ...
            {
              "q": "Acepto el diagnóstico del autor. ___, no comparto su conclusión.",
              "o": [
                "Dicho esto",
                "Además",
                "Por eso"
            ...
            {
              "q": "Sabemos que el riesgo existe. ___, seguimos invirtiendo.",
              "o": [
                "Aun así",
                "De ahí que",
                "En efecto"
            ...
            {
              "q": "La fibra óptica quedó instalada; los chips, ___, hay que reemplazarlos cada pocos años.",
              "o": [
                "por lo tanto",
                "en cambio",
                "de hecho"
        ...
        },
        {
          "tipo": "modelo",
          "id": "e6c",
          "t": "C · Refutar en una oración",
          "intro": "Refutá cada afirmación con el conector indicado. Primero aceptá algo, después mostrá dónde falla.",
          "items": [
            {
              "q": "«Toda burbuja deja infraestructura útil.» → <b>no obstante</b>",
              "m": "Es cierto que muchas burbujas dejaron infraestructura aprovechable; no obstante, un chip que se deprecia en cinco años no es comparable a una vía férrea."
            },
            {
              "q": "«Si las empresas invierten tanto, algo saben.» → <b>ahora bien</b>",
              "m": "Las grandes empresas manejan información que nosotros no tenemos. Ahora bien, esa información no les impidió equivocarse en 2008."
            },
            {
              "q": "«La productividad va a llegar, es cuestión de tiempo.» → <b>aun así</b>",
              "m": "Puede que los aumentos de productividad terminen apareciendo. Aun así, el problema no es si llegan, sino si llegan antes de que venza la deuda."
            },
            {
              "q": "«Comparar la IA con las punto com es exagerado.» → <b>de hecho</b>",
              "m": "La comparación tiene límites evidentes. De hecho, la diferencia juega en contra de la IA: la fibra óptica sigue en servicio y los chips no."
            }
          ]
        }
      ],
      "essay": {
        ...
        "maxWords": 190,
        "checklist": [
          "Tres conectores del ejercicio B; uno tiene que ser de ahí que + subjuntivo.",
    ...
    },
    {
      ...
      "exercises": [
        {
          ...
          "items": [
            {
              "q": "El ___ que provocan los centros de datos rara vez se mide antes de aprobarlos.",
              "a": [
                "estrés ecológico"
              ]
            },
            {
              "q": "La disputa por las ___ reordena la política exterior de las potencias.",
              "a": [
                "tierras raras"
              ]
            },
            {
              "q": "La nueva doctrina de seguridad habla de controlar las ___ críticas.",
              "a": [
                "cadenas de suministro"
              ]
            },
            {
              "q": "El autor cierra hablando de una acumulación por ___.",
              "a": [
                "desposesión"
              ]
            },
            {
              "q": "El ___ de datos repite la lógica del extractivismo de recursos naturales.",
              "a": [
                "extractivismo"
              ]
            },
            {
              "q": "Ningún proyecto se aprobó con una evaluación seria de su ___.",
              "a": [
                "impacto socioambiental"
              ]
            },
            {
              "q": "La ___ de estas instalaciones compite con el consumo de las ciudades vecinas.",
              "a": [
                "huella hídrica"
              ]
            },
            {
              "q": "Los gobiernos deberían exigir ___ concretas: empleo local, insumos, transferencia.",
              "a": [
                "contrapartidas"
              ]
            },
            {
              "q": "Sin un ___ claro, la negociación la gana siempre la misma parte.",
              "a": [
                "marco regulatorio"
              ]
            },
            {
              "q": "Habría que exigir condiciones de ___ futura, no solo acceso gratuito al servicio.",
              "a": [
                "reinversión"
              ]
            }
        ...
        },
        {
          ...
          "id": "e7b",
          "t": "B · Condicionales",
          "intro": "Escribí los verbos en la forma correcta.",
          "regla": "<b>Probable / real</b>: si + presente de indicativo → futuro. <i>Si las inversiones se frenan, la capacidad se reducirá.</i><br><b>Hipotético / poco probable</b>: si + imperfecto de subjuntivo → condicional. <i>Si las inversiones se frenaran, la capacidad se reduciría.</i>",
          "items": [
            {
              "q": "[hipotético] Si la burbuja ___ (estallar), los países periféricos pagarían el costo.",
              "a": [
                "estallara",
                "estallase"
              ]
            ...
            {
              "q": "[hipotético] Si el gobierno exigiera contrapartidas, el acuerdo ___ (ser) muy distinto.",
              "a": [
                "sería"
              ]
            },
            {
              "q": "[probable] Si las inversiones se frenan el año que viene, la capacidad disponible ___ (reducirse).",
              "a": [
                "se reducirá"
              ]
            },
            {
              "q": "[hipotético] Si nosotros ___ (tener) infraestructura propia, no dependeríamos de nadie.",
              "a": [
                "tuviéramos",
                "tuviésemos"
              ]
            ...
            {
              "q": "[probable] Si el precio sube, muchas empresas ___ (abandonar) el servicio.",
              "a": [
                "abandonarán"
              ]
            },
            {
              "q": "[hipotético] Si la analogía con los ferrocarriles ___ (funcionar), el legado sería duradero.",
              "a": [
                "funcionara",
                "funcionase"
              ]
            ...
            {
              "q": "[hipotético] Si me ___ (preguntar, ellos) hoy, respondería que se trata de una burbuja.",
              "a": [
                "preguntaran",
                "preguntasen"
              ]
            ...
            {
              "q": "[probable] Si Brasil no regula ahora, ___ (repetir) la historia de siempre.",
              "a": [
                "repetirá"
              ]
            }
        ...
        },
        {
          ...
          "id": "e7c",
          "t": "C · Proyectar",
          "intro": "Escribí una hipótesis para cada escenario, con <b>si + imperfecto de subjuntivo + condicional</b>.",
          "items": [
            {
              "q": "Escenario: la burbuja estalla y Brasil ya tiene centros de datos instalados.",
              "m": "Si la burbuja estallara con los centros de datos ya instalados, Brasil se quedaría con la infraestructura, el consumo energético y ninguna de las ganancias."
            },
            {
              "q": "Escenario: los gobiernos de la región negocian en bloque en lugar de uno por uno.",
              "m": "Si los gobiernos de la región negociaran en bloque en lugar de hacerlo por separado, estarían en condiciones de exigir contrapartidas que hoy nadie exige."
            },
            {
              "q": "Escenario: la IA cumple todo lo que promete.",
              "m": "Si la IA cumpliera todo lo que promete, la pregunta seguiría siendo quién se queda con el excedente y en qué país."
            },
            {
              "q": "Escenario: no hay ni burbuja ni transformación, solo un estancamiento largo.",
              "m": "Si no hubiera ni estallido ni revolución, sino un estancamiento prolongado, el costo lo pagarían igual quienes aportaron la energía y el agua."
            }
          ]
        }
      ],
      "essay": {
        ...
        "maxWords": 170,
        "checklist": [
          "Una condicional hipotética (si + imperfecto de subjuntivo + condicional).",
          "Una relativa con cuyo o con preposición + el cual.",
          "Ninguna palabra en inglés."
        ]
      },
      ...
      "exercises": [
        {
          "tipo": "opcion",
          "id": "e8a",
          "t": "A · Los errores de siempre",
          "intro": "En cada par, una versión es correcta en español. Elegí cuál.",
          "items": [
            {
              "q": "El gasto está verificado y querés afirmarlo:",
              "o": [
                "Aunque el gasto es enorme, nadie garantiza nada.",
                "Aunque el gasto sea enorme, nadie garantiza nada."
              ],
              "a": 0
            },
            {
              "q": "",
              "o": [
                "A pesar de la inversión ser enorme, el retorno es incierto.",
                "A pesar de que la inversión es enorme, el retorno es incierto."
              ],
              "a": 1
            },
            {
              "q": "Se trata de 5.000.000.000 de dólares:",
              "o": [
            ...
            {
              "q": "Querés decir que también las grandes se endeudan:",
              "o": [
                "Hasta las grandes empresas se endeudan.",
                "Incluso las grandes empresas se endeudan."
              ],
              "a": 1
            },
            {
              "q": "",
              "o": [
                "Los invertidores minoristas llegaron tarde.",
                "Los inversores minoristas llegaron tarde."
              ],
              "a": 1
            },
            {
              "q": "",
              "o": [
                "La lucratividad del sector cayó.",
                "La rentabilidad del sector cayó."
              ],
              "a": 1
            },
            {
              "q": "",
              "o": [
                "Es un mecanismo que a través de él vuelve el capital.",
                "Es un mecanismo a través del cual vuelve el capital."
              ],
              "a": 1
            },
            {
              "q": "",
              "o": [
                "No creo que es una burbuja.",
                "No creo que sea una burbuja."
              ],
              "a": 1
            },
            {
              "q": "",
              "o": [
                "Según el autor dice que los números no cuadran.",
                "Según el autor, los números no cuadran."
              ],
              "a": 1
            },
            {
              "q": "",
              "o": [
                "Yo concuerdo con el autor en este punto.",
                "Coincido con el autor en este punto."
              ],
              "a": 1
            }
          ]
        },
        {
          "tipo": "check",
          "id": "e8b",
          "t": "B · Lista de revisión",
          "intro": "Pasá tu texto por esta lista antes de darlo por terminado. Marcá cada punto solo cuando lo hayas verificado de verdad.",
          "items": [
            "Mi tesis aparece en una sola oración y se entiende sin leer el resto.",
            "Cada párrafo hace un solo movimiento: presentar, conceder, argumentar, refutar, concluir.",
            "Usé al menos cuatro verbos de atribución distintos y ninguno es «decir».",
            "Hay al menos tres concesivas y no todas empiezan con «aunque».",
            "Revisé cada «aunque»: ¿indicativo o subjuntivo? ¿Por qué?",
            "Hay al menos tres relativas con preposición + el cual, o con cuyo.",
            "Modalicé mis afirmaciones más arriesgadas en lugar de sostenerlas a los gritos.",
            "No quedó ninguna palabra en inglés.",
            "Revisé todas las cifras: mil millones y billones no son lo mismo.",
            "La conclusión no repite la introducción con otras palabras.",
            "Leí el texto en voz alta y no me quedé sin aire en ninguna oración.",
            "Conté las palabras: entre 500 y 650."
          ]
        }
      ],
      "essay": {
        ...
        "maxWords": 650,
        "checklist": [
          "Cinco párrafos: introducción y tesis, argumento, concesión, refutación, conclusión.",
